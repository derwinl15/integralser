...
!(function (t) {
    ...
    (e.Defaults = {
        ...
        menuSize: "normal",
        items: [],
        iconsAnimationSpeed: 0,//1200
        theme: "#FFF",
        buttonIcon:
            '<img src="images/contacto_ppal.png" style="height: 60px; margin-top: -15px" />',
        closeIcon:
            '<img src="images/contacto_ppal.png" style="height: 60px; margin-top:-3px; margin-left:29px" />',
    }),
...
arcItem.icon = '<img src="images/iconotel.png"  />';
arcItem.href = 'tel:1138624965';
arcItem.color = '#FFF';
...
arcItem.icon = '<img src="images/contacto_wa.png"  />';
arcItem.href = 'https://api.whatsapp.com/send?phone=5491138624965';
arcItem.color = '#FFF';
arcItems.push(arcItem);
...
arcItem.class = '';
arcItem.title = 'Escribinos';
arcItem.icon = '<img src="images/contacto_mail.png"  />';
arcItem.href = 'mailto:info@integralser.com.ar';
arcItem.color = '#FFF';
arcItems.push(arcItem);
